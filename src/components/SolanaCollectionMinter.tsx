    ...
    return (
        <>
            <div className="space-y-6 bg-white py-6 px-4 sm:p-6">
                <div>
                    <h3 className="text-lg font-medium leading-6 text-gray-900">Create Solana Collection</h3>
                ...
                <Button
                    ...
                    onClick={async () => {
                        ...
                        if (nft) {
                            ...
                            toast("Verifying")
                            await metaplex.nfts().verifyCollection({ mintAddress: nft.mintAddress, collectionMintAddress: nft.nft.address }).catch(() => { })
